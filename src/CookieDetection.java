    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (String url : websitesToTest) {
            try {
                ...
                // Find all elements with class names containing keywords cookie
                List<WebElement> cookieElements = driver.findElements(By.xpath("//*[contains(text(),'cookie') or contains(text(),'Cookie')]"));


                // Print the count of banners and alerts before the delay
                System.out.println("Total number of cookie elements before: " + cookieElements.size());
                ...
                List<WebElement> cookieElementsAfter = driver.findElements(By.xpath("//*[contains(text(),'cookie') or contains(text(),'Cookie')]"));


                // Print the count of hidden or closed banners and alerts after the delay
                System.out.println("Total number of cookie elemts after: " + cookieElementsAfter.size());

                // Check if bannersAndAlertsAfter.size() is less than bannersAndAlerts.size()
                if (cookieElementsAfter.size() != cookieElements.size()) {
                    counter++;
                }
        ...
        System.out.println("Number of websites with fewer cookie element after: " + counter);
    }
}
